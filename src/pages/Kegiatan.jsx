...
export default function Kegiatan() {
  ...
  const realList = useMemo(
    () => kegiatanList.filter((k) => k.nama && k.nama.trim().length > 0),
    []
  )
      ...
      <section className="relative h-48 md:h-56 -mt-20 pt-20 flex items-center bg-gradient-to-br from-surface-50 via-surface-50 to-primary-50 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
          <ScrollReveal direction="up">
            <h1 className="font-serif text-3xl md:text-5xl text-dark-800">
              Jadwal Kegiatan
            </h1>
            <p className="text-dark-700 mt-2 max-w-2xl">
              Kajian rutin, kegiatan insidental, dan majelis online bersama Ustadz
              Fauzan.
            </p>
          </ScrollReveal>
        </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${
                      isActive
                        ...
                        : 'bg-white text-dark-700 border border-surface-200 hover:border-primary-400 hover:text-primary-500'
                    }`}
                  >
                    {f.label}
                  </button>
          ...
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-dark-700 mt-1 text-sm max-w-md">
                Hubungi kami via WhatsApp untuk info kajian rutin dan undangan dakwah.
              </p>
              <a
                href={waLink}
                target="_blank"
            ...
            <div className="relative flex flex-col md:flex-row md:items-center gap-6 md:gap-8">
              <div className="flex-1">
                ...
                <p className="text-white/85 mt-2 leading-relaxed">
                  Undang Ustadz Fauzan untuk mengisi kajian, tabligh akbar, atau
                  konsultasi syariah di lembaga Anda.
                </p>
              </div>
              <a
                href={waLink}
